...
def serialize_community_admin(community: Community) -> dict[str, Any]:
    ...
    return {
        ...
        "isApproved": bool(getattr(community, "is_approved", False)),
        "skills": community.skills,
        "location": community.location,
        "linkedInId": getattr(community, "linked_in_id", None),
        "linked_in_id": getattr(community, "linked_in_id", None),
        "linkedInProfileUrl": getattr(community, "linked_in_profile_url", None),
        "whyImHere": getattr(community, "why_im_here", None),
        "expectedRate": getattr(community, "expected_rate", None),
